...
from policy_embodied_runtime.robot.registry import AutoRegisteringMeta, create_registered
from policy_embodied_runtime.protocol.common import MappingProcessorRule, MappingRule, ProcessorSpec
